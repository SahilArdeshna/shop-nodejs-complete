...
//             const existingProd =  products.find(prod => {
//               return prod._id.toString() === item.productId.toString();
//             });
//             console.log(existingProd);
//             return existingProd && existingProd._id;
//           });

//           console.log(updatedProducts);

//           db.collection('users').updateOne({ _id: new ObjectId(this._id) }, { $set: { cart: { items: updatedProducts } } });
//         }
